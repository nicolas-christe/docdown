...
public class NavHeaderRenderable implements Renderable {

    private final DefaultGenerator generator;

    public NavHeaderRenderable(DefaultGenerator generator) {
    ...
    public void renderOn(HtmlCanvas html) throws IOException {
        ...
        DocReferenceable ref = generator.getRefLocator().getMarkupDocRef(generator.getRootProjectDoc()
                .getRootMarkupDoc());
        html.p().a(href(page.getReferenceTo(ref))).content(generator.getTitle())._p();
    }
}
